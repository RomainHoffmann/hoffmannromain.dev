...
export function SiteHeader() {
  return (
    <header className="pointer-events-none fixed inset-x-0 top-0 z-[var(--z-header)] flex justify-center px-gutter pt-[var(--space-lg)] md:px-gutter-lg md:pt-[var(--space-xl)]">
